...
public class Main {
    ...
    static String oracleUserName = "kimiweng"; // replace with your uniqname
    static String password = "Gounod8herdic"; // replace with your Oracle password (default: eecsclass)
