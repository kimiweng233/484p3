let dbname = "raymonwu"; // replace with your uniqname
...
(function () {
  ...
  if (Object.keys(test5).length == 798) {
    if (test5.hasOwnProperty(799)) {
      ...
      if (test5[799] == 51) {
        ...
        print("Local test failed!");
        print(
          "Expected oldest friend for user 799 to be 51, you found",
          ans5,
          "."
        );
      }
      ...
      print("Local test failed!");
      print(
        "Expected oldest friend for user 799 to be 51. You found no oldest friend for user 799."
      );
    }
  } else {
    print("Local test failed!");
  ...
  if ((ans6 > 26) & (ans6 < 27)) {
    ...
    print("Local test failed!");
    print(
      "Expected the average number of friends to be between 26 to 27, you calculated",
      ans6,
      "friends."
    );
  }
